...
func Authenticate(username string, password string) string {
    ...
    if(username == "ece30861defaultadminuser" && password == "correcthorsebatterystaple123(!__+@**(A'\"`;DROP TABLE packages;") {//"correcthorsebatterystaple123(!__+@**(A\u2019\u201D`;DROP TABLE packages;") {
